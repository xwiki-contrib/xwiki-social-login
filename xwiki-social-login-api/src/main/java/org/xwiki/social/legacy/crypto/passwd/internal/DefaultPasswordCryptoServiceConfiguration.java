...
import org.xwiki.social.legacy.crypto.passwd.KeyDerivationFunction;
import org.xwiki.social.legacy.crypto.passwd.PasswordCiphertext;
import org.xwiki.social.legacy.crypto.passwd.PasswordCryptoServiceConfiguration;
import org.xwiki.social.legacy.crypto.passwd.PasswordVerificationFunction;

/**
 * Default implementation of {@link PasswordCryptoServiceConfiguration}.
 * 
 * @version $Id: bd4215bf87167e4baeb6bdbb8a884858c9062ecd $
 */
@Component
@Singleton
public class DefaultPasswordCryptoServiceConfiguration implements PasswordCryptoServiceConfiguration
{
    ...
    /**
     * Default {@link java.util.Properties} for the {@link org.xwiki.social.legacy.crypto.passwd.KeyDerivationFunction}s.
     */
    ...
    /** configuration key for which {@link org.xwiki.social.legacy.crypto.passwd.PasswordCiphertext} class to use. */
    ...
    /** configuration key for which {@link org.xwiki.social.legacy.crypto.passwd.KeyDerivationFunction} to use for encryption. */
    private final String keyDerivationFunctionClassForEncryption = "keyDerivationFunctionClassForEncryption";

    /** Default {@link org.xwiki.social.legacy.crypto.passwd.KeyDerivationFunction} class to use for encryption. */
    private final Class<?> defaultKeyDerivationFunctionClassForEncryption =
        PBKDF2KeyDerivationFunction.class;

    /**
     * Key for {@link java.util.Properties} for the {@link org.xwiki.social.legacy.crypto.passwd.KeyDerivationFunction} 
     * used for encryption.
     */
    ...
    /**
     * Default {@link java.util.Properties} for the {@link org.xwiki.social.legacy.crypto.passwd.KeyDerivationFunction} 
     * used for encryption.
     */
    private final Properties defaultKeyDerivationFunctionPropertiesForEncryption =
        this.defaultKeyDerivationFunctionProperties;

    /** configuration key for which {@link org.xwiki.social.legacy.crypto.passwd.PasswordVerificationFunction} class to use. */
    ...
    /** configuration key for which {@link org.xwiki.social.legacy.crypto.passwd.KeyDerivationFunction} to use for passwords. */
    private final String keyDerivationFunctionClassForPasswordVerification = 
        "keyDerivationFunctionClassForPasswordVerification";

    /** Default {@link org.xwiki.social.legacy.crypto.passwd.KeyDerivationFunction} class to use for password verification. */
